...
function createElements() {
  ...
  for (var i = 0; i < finalCount; i++) {
    ...
    blockData = new MemoryBlock(i, cardFront, "Images/BackgroundImage.png");
    memoryBlockArr[i] = blockData;

    const divblock = document.createElement("div");
    const divblockFront = document.createElement("div");
    const divblockBack = document.createElement("div");
